...
contract Portfolio {
    ...
    string public imageLink = "QmWz3vYiPcbM2drPsiVFfCxWKysLKvzi6APk8ZK8jfQpom";
    string public description = "";
    string public resumeLink = "QmUtjww8UgQidUvWKemXZBs16NQay8DutUrDZdDxdvUEsv";
    uint projectCount;
    uint educationCount;
    ...
    function insertEducation(string calldata _date, string calldata _degree, string calldata _knowledgeAcquired, string calldata _instutionName) external onlyManager {
        require(educationCount < 3, "Only 3 Education Details are allowed");
